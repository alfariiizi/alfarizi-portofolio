  ...
  return (
    <div>
      <nav className="relative z-20">
        <div className="md:px-30 fixed top-0 left-0 right-0 flex justify-between border-b-[1px] border-b-slate-200 bg-gradient-to-t from-blue-100/30 to-violet-100/30 px-10 py-7 backdrop-blur-sm duration-200 dark:border-b-slate-900 sm:px-20 lg:px-40">
